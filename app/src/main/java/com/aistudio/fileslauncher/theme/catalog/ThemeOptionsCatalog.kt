...
object ThemeOptionsCatalog {
  ...
  val all100Themes: List<CatalogThemeEntry> by lazy {
    ...
    list.add(CatalogThemeEntry("minimalist_charcoal", AppThemeMode.MIDNIGHT_MATTE_BLACK, "Minimalist Charcoal", "Flat dark charcoal (#121212) neutral theme", 0xFF121212, 0xFFE0E0E0, 1))
    list.add(CatalogThemeEntry("stealth_slate", AppThemeMode.MIDNIGHT_MATTE_BLACK, "Stealth Slate", "Flat dark slate (#1A1A1A) neutral theme", 0xFF1A1A1A, 0xFFB0B0B0, 1))
